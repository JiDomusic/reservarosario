-- CONFIGURACIÓN SUPABASE PARA SODITA
...
-- Política para leer mesas (todos pueden ver)
CREATE POLICY "Todos pueden ver mesas" ON sodita_mesas
    FOR SELECT USING (true);

-- Política para insertar reservas (todos pueden crear)
CREATE POLICY "Todos pueden crear reservas" ON sodita_reservas
    FOR INSERT WITH CHECK (true);

-- Política para leer reservas (todos pueden ver)
CREATE POLICY "Todos pueden ver reservas" ON sodita_reservas
    FOR SELECT USING (true);

-- Política para actualizar reservas (solo admin autenticado)
