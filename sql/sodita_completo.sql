-- ================================================
-- SCRIPT COMPLETO PARA EJECUTAR EN SUPABASE
-- ================================================
-- Ve a: https://supabase.com/dashboard/project/weurjculqnxvtmbqltjo
-- Abre: SQL Editor
...
CREATE POLICY "Todos pueden actualizar reservas" ON sodita_reservas
