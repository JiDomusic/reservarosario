...
class SoditaMainScreen extends StatefulWidget {
  const SoditaMainScreen({super.key});

  @override
  State<SoditaMainScreen> createState() => _SoditaMainScreenState();
}

class _SoditaMainScreenState extends State<SoditaMainScreen> with TickerProviderStateMixin {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const ExactSoditaLogo(width: 120, height: 40),
                      const Spacer(),
                      _buildQuickMetrics(),
                    ],
                  ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isOpen ? '🟢 SODITA ABIERTO' : '🔴 SODITA CERRADO',
                  style: GoogleFonts.inter(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                    color: isOpen ? const Color(0xFF10B981) : const Color(0xFFF44336),
