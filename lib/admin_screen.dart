...
class _AdminScreenState extends State<AdminScreen> with TickerProviderStateMixin {
  ...
  void _showReviewModerationPanel() async {
    print('🚀 INICIANDO PANEL DE MODERACIÓN DESDE ADMIN...');
    try {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                TextButton.icon(
                  onPressed: () => _editReviewFromAdmin(review),
                ...
                const SizedBox(width: 8),
                TextButton.icon(
                  onPressed: () => _hideReviewFromAdmin(review['id']),
                ...
                const SizedBox(width: 8),
                TextButton.icon(
                  onPressed: () => _deleteReviewFromAdmin(review['id']),
